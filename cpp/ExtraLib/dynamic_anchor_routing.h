...
// =============================================================================
#ifndef DYNAMIC_ANCHOR_ROUTING_H_
#define DYNAMIC_ANCHOR_ROUTING_H_
...
struct DynamicAnchorRoutingFunctor {
...
// #if GOOGLE_CUDA == 1
// template <typename T>
// struct DynamicAnchorRoutingFunctor<GPUDevice, T> {
...
#endif // DYNAMIC_ANCHOR_ROUTING_H_
