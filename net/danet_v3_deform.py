...
class VGG16Backbone(object):
    ...
    def se_inception_block(self, features, name=None, reuse=None):
        with tf.variable_scope(name, 'se_inception_block', reuse=reuse):
            ...
            deform_conv1 = custom_op.deform_conv_2d(conv_1x1_down, 256, kernel_size_h=3, kernel_size_w=3, stride=1, dilate_rate=1, deformable_group=4, data_format=self._data_format, no_bias=False, kernel_initializer=self._conv_initializer, name='deform_conv1')
            ...
            conv_1x1_up = tf.layers.conv2d(tf.nn.relu(deform_conv2), top_channels, (1, 1), strides=1,
