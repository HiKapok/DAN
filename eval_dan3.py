...
tf.app.flags.DEFINE_integer(
    'cascaded_skip', 6, 'Number of skip layers in the cascaded stage.')
tf.app.flags.DEFINE_integer(
...
def main(_):
    with tf.Graph().as_default():
        ...
        with tf.variable_scope(FLAGS.model_scope, default_name=None, values=[features], reuse=tf.AUTO_REUSE):
            ...
            final_location_pred, final_cls_pred = backbone.get_se_predict_module(feature_layers[0:FLAGS.cascaded_skip], [1] * len(feature_layers),
